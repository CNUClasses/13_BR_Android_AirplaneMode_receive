package com.example.perkins.br_android_airplanemode_receive;
...
/**
 * Created by Perkins on 3/30/2015.
 */
public class BR_LOTS_OF_STUFF extends BroadcastReceiver{
    /**
    ...
    public void onReceive(Context context, Intent intent) {
        boolean bOn = intent.getBooleanExtra("state",false );
        String myString = "PLEASE DO NOT POP UI FROM BROADCAST RECEIVERS\nHowever for demo\nAirplane Mode toggled \nor Power (dis)Connected";
